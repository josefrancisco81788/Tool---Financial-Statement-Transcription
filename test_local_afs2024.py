...
def test_afs2024_extraction():
    """Test extraction with the AFS2024 file that has multi-year data"""
    try:
        # Test with the AFS2024 file
        with open('data/input/documents/AFS2024 - statement extracted.pdf', 'rb') as f:
            ...
            print("📤 Testing AFS2024 extraction...")
            ...
            if response.status_code == 200:
                ...
                years_detected = result.get('data', {}).get('years_detected', [])
                ...
                if 'csv_data' in result:
                    ...
                    with open('test_local_afs2024_result.json', 'w') as f:
                        json.dump(result, f, indent=2)
                    print("💾 Full result saved to test_local_afs2024_result.json")
                    
                    with open('test_local_afs2024_result.csv', 'w') as f:
                        f.write(csv_data)
                    print("💾 CSV saved to test_local_afs2024_result.csv")
...
if __name__ == "__main__":
    print("🧪 Testing Local API with AFS2024")
    print("=" * 40)
    
    test_afs2024_extraction()
