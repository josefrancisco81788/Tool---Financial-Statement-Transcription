"""
Robust 2021 AFS with SEC Stamp extraction with better error handling and consolidation
"""
...
def create_field_mapping(extracted_data: Dict[str, Any]) -> Dict[str, Dict[str, Any]]:
    ...
    field_mappings = {
        ...
        'Balance Sheet|Current Assets|Current Inventories': 'inventories',
        ...
        # Non-Current Assets
        'Balance Sheet|Non Current Assets|Property, Plant and Equipment': 'property_and_equipments',
        ...
        'Balance Sheet|Non Current Assets|Other non-current non-financial assets': 'other_assets',
...
def main():
    ...
    pdf_path = "tests/fixtures/light/2021 AFS with SEC Stamp - statement extracted.pdf"
    output_csv_path = "tests/outputs/2021_afs_sec_robust_template.csv"
