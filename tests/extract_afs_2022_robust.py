"""
Robust AFS 2022 extraction with better error handling and consolidation
"""
...
def main():
    ...
    pdf_path = "tests/fixtures/light/AFS-2022 - statement extracted.pdf"
    output_csv_path = "tests/outputs/afs_2022_robust_template.csv"
