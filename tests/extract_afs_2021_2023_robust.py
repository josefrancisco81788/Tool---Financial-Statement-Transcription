"""
Robust AFS 2021-2023 extraction with better error handling and consolidation
"""
...
def main():
    ...
    pdf_path = "tests/fixtures/light/afs-2021-2023 - statement extracted.pdf"
    output_csv_path = "tests/outputs/afs_2021_2023_robust_template.csv"
